        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            >
                ...
                <View style={styles.actionsGrid}>
                    ...
                    <ActionButton icon="download-outline" label="Request" color="#FFF9DB" onPress={() => Alert.alert('Request', 'Coming soon!')} />
                    <ActionButton icon="grid-outline" label="Invoices" color="#FFF9DB" onPress={() => Alert.alert('Invoices', 'Coming soon!')} />
